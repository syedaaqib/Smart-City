 ...
 * 
 * XDoclet definition:
 * @struts.action path="/busInfo" name="busInfoForm" input="/form/busInfo.jsp" scope="request" validate="true"
...
public class BusInfoAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		BusInfoForm bus = (BusInfoForm) form;// TODO Auto-generated method stub

	    boolean flag=new BusinessInfoDao().businessisert(bus);
		if(flag)
